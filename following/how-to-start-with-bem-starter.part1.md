...
репозиторий [full-stack-starter](https://github.com/bem/full-stack-starter)<sup>[1](#ref2)</sup>.
...
На вашем компьютере запустился `bem server`<sup>[2](#ref2)</sup> — инструмент для разработки,
...
ерезагрузив страницу, вы увидите что в ней появился соответствующий `<div>`.
